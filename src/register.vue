<template>
    ...
    <div class="logins">
      <div class="logins-wrap">
        <div class="w1200 clearfix" style="padding-top:50px;">
          <div class="login">
            <div class="login2">
              <h3>免费注册账号</h3>
              <form>
                <div class="login-div2">
                  ...
                  <div class="wrongtips"><p>您输入额信息有误，请重新输入</p></div>
                </div>
                <div class="login-div2">
                  <div id="drag">
                ...
                <div class="yzm login-div2">
                  <div class="clearfix">
                    <div class="yanzhengma login-div">
                      <dl class="clearfix">
                        <dd><input type="text" class="shoujihao" placeholder='手机验证码'></dd>
                      </dl>
                    </div>
                    <div class="send"><button>发送验证码</button></div>
                  </div>
                </div>
                <div class="login-div2">
                ...
                <div class="rempwd clearfix">
                  <span><input type="checkbox" />&nbsp;注册即代表同意 <a href="#">《爱米理财服务协议》</a></span>
                </div>
                <div class="btns submit" style="padding-top:20px;">
                  <input type="submit" value="立即确认" class="loginnow button">
                </div>
                <div class="reg">已有账号？<a href="#">立即登录</a></div>
              </form>
            </div>
          </div>
        </div>
